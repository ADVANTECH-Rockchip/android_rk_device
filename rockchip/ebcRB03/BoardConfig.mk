...
-include vendor/rockchip/ebcRB03/BoardConfigVendor.mk
...
TARGET_CPU_SMP := true
PRODUCT_PACKAGE_OVERLAYS += device/rockchip/ebcRB03/overlay

TARGET_BOARD_PLATFORM := rk3288
TARGET_BOARD_PLATFORM_GPU := mali-t760
#TARGET_BOARD_INFO_FILE := device/rockchip/ebcRB03/board-info.txt
...
DEVICE_PACKAGE_OVERLAYS += device/rockchip/ebcRB03/overlay_screenoff
