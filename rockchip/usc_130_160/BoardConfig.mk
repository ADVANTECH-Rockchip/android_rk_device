...
-include vendor/rockchip/usc_130_160/BoardConfigVendor.mk
...
TARGET_CPU_SMP := true
PRODUCT_PACKAGE_OVERLAYS += device/rockchip/usc_130_160/overlay

TARGET_BOARD_PLATFORM := rk3288
TARGET_BOARD_PLATFORM_GPU := mali-t760
#TARGET_BOARD_INFO_FILE := device/rockchip/usc_130_160/board-info.txt
...
DEVICE_PACKAGE_OVERLAYS += device/rockchip/usc_130_160/overlay_screenoff
