...
-include vendor/rockchip/rsb4680/BoardConfigVendor.mk
...
TARGET_CPU_SMP := true
PRODUCT_PACKAGE_OVERLAYS += device/rockchip/rsb4680/overlay

TARGET_BOARD_PLATFORM := rk3288
TARGET_BOARD_PLATFORM_GPU := mali-t760
#TARGET_BOARD_INFO_FILE := device/rockchip/rsb4680/board-info.txt
...
DEVICE_PACKAGE_OVERLAYS += device/rockchip/rsb4680/overlay_screenoff
