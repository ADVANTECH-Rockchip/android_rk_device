...
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/init.usm110.rc:root/init.usm110.rc \
...
PRODUCT_COPY_FILES += \
    device/rockchip/usm110/public.libraries.txt:vendor/etc/public.libraries.txt
...
PRODUCT_PROPERTY_OVERRIDES += \
		...
		ro.config.wallpaper=system/media/rkfactory/default_wallpaper.jpg
